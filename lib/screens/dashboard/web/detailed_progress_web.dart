    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Expanded(child: _buildErrorCountTile('OMISSION', eval.omissions, Colors.red)),
            const SizedBox(width: 8),
            Expanded(child: _buildErrorCountTile('REPETITION', eval.repetitions, Colors.red.shade300)),
            const SizedBox(width: 8),
            Expanded(child: _buildErrorCountTile('SELF CORRECTION', eval.selfCorrections, Colors.green)),
            const SizedBox(width: 8),
            Expanded(child: _buildErrorCountTile('MISPRONUNCIATION', eval.mispronunciations, Colors.amber)),
          ],
        ),
        const SizedBox(height: 20),
        // Color-coded Story box
        _buildStoryCodeCard(),
      ],
    );
  }
